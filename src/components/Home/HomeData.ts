    ...
    services_data: [
      {
        ...
        color: 'bg-tr_yellow',
        content: `هو نشاط يعتمد على يعنى بإقامة أنشطة تدريبية ورحلات ترفيهية وألعاب حركية تهدف جميعها إلى تنمية شخصية الطفل والمراهق وتعديل سلوكه وإثراء شخصيته الفكرية والاجتماعية والأخلاقية، ويتم ذلك على أيدي متخصصين في التربية وتعديل السلوك، وبطرق حديثة ومبتكرة.`
      },
      {
        img: '/images/1.jpg',
        ...
        color: `bg-tr_green`,
        content: `Code Valley هي إحدى مشروعات مؤسسة ترينوبيا وتهدف إلى تعليم الأطفال والمراهقين علوم الكمبيوتر ولغات البرمجة بوجه خاص من خلال طرق تعليم حديثة ومبتكرة. وتعتمد Code Valley في منهجها على مواد تعليمية معتمدة من كبرى الشركات العالمية كشركة Google Education و Microsoft، وكمبادرة Code.org العالمية. وتقدم الأكاديمية برامجها للأطفال والمراهقين من سن 8 سنوات وحتى 16 عامًا.`
      },
      {
        img: '/images/1.jpg',
        logo: '/icons/kids-logo-light.png',
        ...
        content: `هي رحلات تدريبية ترفيهية موجهة لكل أفراد الأسرة، ومناسبة لجميع الفئات العمرية، وتعتمد على الملازمة لمدة أربعة أيام تدريبية بالإقامة الكاملة في أحد الفنادق أو المنتجعات السياحية. وتهدف المخيمات التدريبية إلى توطيد علاقات الأسر وخلق مناخ عائلي صحي ومتكامل يتلقى فيه البالغون محاضرات تدريبية، ويعيش الأطفال والمراهقون كذلك تجربة تدريبية وتربوية لا تنسى مليئة بالألعاب والأنشطة المختلفة والرحلات الترفيهية داخل إحدى المدن الساحلية في مصر.`
      }
      // {
      //   img: '/images/1.jpg',
      //   title: {
